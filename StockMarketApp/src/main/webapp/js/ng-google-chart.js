...
(function (document, window, angular) {
    ...
    angular.module('googlechart', ['ui.bootstrap'])
            ...
            return {
                ...
                link: function ($scope, $elm) {
					...
					ws.onmessage = function(message) {
						...
						{	
							$scope.chart.data = {"cols": JSON.parse(message.data).chartColumns, "rows": JSON.parse(message.data).chartData};
						}
						else
						{
							$scope.chart.data = {"cols": JSON.parse(message.data).chartColumns, "rows": []};
						}	
						draw();
					};
